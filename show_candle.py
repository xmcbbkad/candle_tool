...
class InterCandle:
    def __init__(self, data_folder, date, style):
        ...
        file_name = "{}/{}.csv".format(data_folder, date)
...
if __name__ == "__main__":
    candle = InterCandle(data_folder = '/Users/xiaokunfan/programme_trading/candle_tool/data/taobao_TSLA', date='2022-01-24', style=my_style)
